...
.login-overlay {
  display: flex;
  align-items: center; /* Membuat item di tengah secara vertikal */
  justify-content: center; /* Membuat item di tengah secara horizontal */
  flex: 1;
  width: 100%;
  padding: 2rem 1rem; /* Memberi jarak atas-bawah */
  background-color: rgba(0, 0, 0, 0.55);
}

.login-box {
  width: 100%;
  max-width: 400px; /* Dilebarkan dari 380px */
  margin: 0; /* Margin tidak lagi diperlukan untuk centering */
}
/* === AKHIR PERUBAHAN === */
