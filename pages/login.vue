...
<script setup>
// Mengimpor semua yang dibutuhkan dari Vue dan composable kita
import { ref, reactive } from 'vue';
import { useAuth } from '~/composables/useAuth';

// Mendefinisikan layout 'auth' untuk halaman ini
definePageMeta({
  layout: 'auth'
});

// Menggunakan composable useAuth
const { login, loading } = useAuth();

// Menggunakan 'reactive' untuk form, persis seperti contoh Anda
...
// Nama fungsi diubah menjadi 'signinUser' seperti contoh Anda
const signinUser = async () => {
  // Langsung memanggil fungsi login dari composable dengan data dari form
  await login(form);
};
</script>
